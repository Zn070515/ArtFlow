...
class AuditLog(models.Model):
    class ActionType(models.TextChoices):
        ...
        TICKET_ISSUE = "ticket_issue", "签发票据"
        TICKET_CHECK_IN = "ticket_check_in", "票据检票"
        TICKET_VOID = "ticket_void", "作废票据"
        TICKET_REVOKE = "ticket_revoke", "撤销票据"
        TICKET_REDEEM = "ticket_redeem", "兑换票据会话"
        TICKET_SESSION_REVOKE = "ticket_session_revoke", "撤销票据会话"
        JUDGE_PANEL_PREPARE = "judge_panel_prepare", "准备评委组"
        JUDGE_PANEL_CHANGE = "judge_panel_change", "变更评委组"
        JUDGE_PANEL_HOLD = "judge_panel_hold", "暂停评委组"
        JUDGE_SEAT_ASSIGN = "judge_seat_assign", "分配评委席位"
        JUDGE_SEAT_REVOKE = "judge_seat_revoke", "撤销评委席位"
        JUDGE_SESSION_ISSUE = "judge_session_issue", "签发评委会话"
        JUDGE_SESSION_REVOKE = "judge_session_revoke", "撤销评委会话"
        JUDGE_PERF_ADVANCE = "judge_perf_advance", "推进评委表演"
        JUDGE_PERF_HOLD = "judge_perf_hold", "暂停评委表演"
        JUDGE_SCORE_SUBMIT = "judge_score_submit", "提交评委评分"
        JUDGE_SCORE_PROXY = "judge_score_proxy", "代录评委评分"
