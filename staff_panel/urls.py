...
urlpatterns = [
    ...
    path("export/import-scores/<int:round_id>/", views.excel_import_scores, name="excel_import_scores"),
    path("word/generate/<int:template_id>/<int:activity_id>/", views.word_generate, name="word_generate"),
    path("execution-package/<int:activity_id>/", views.execution_package, name="execution_package"),
    path("archive-package/<int:activity_id>/", views.archive_package_create, name="archive_package_create"),
    ...
    path("activity/<int:pk>/clear-test/", views.activity_clear_test_data, name="activity_clear_test_data"),
